					...
					<div id="account__page__inpu">
						...
						<form method="post" action="/project/user?cmd=accountUpdate">
							...
							<div class="form-group">
								<h4>계정 정보</h4>
								<br />
								<p>ID: ${accountUser.id}</p>
								<br /> <label>표시 이름</label> <input type="text" class="form-control" id="usr" name="displayName" placeholder="표시명 " value="${accountUser.displayName}">
							</div>
							<br />
							...
							<div class="row">
								<div class="col">
									<label>이름</label> <input type="text" class="form-control" placeholder="이름 " name="text" value="${accountUser.username}" readonly>
								</div>
								<div class="col">
									<label>전화번호</label> <input type="text" class="form-control" placeholder="전화번호 " name="tel" value="${accountUser.tel}">
								</div>
							</div>
							<br />
							<h4>주소</h4>
							...
							<div class="row">
								<div class="col">
									<label>회사명</label> <input type="text" class="form-control" placeholder="회사명 " name="company" value="${accountUser.company}">
								</div>
								<div class="col">
									<label>VAT 번호</label> <input type="text" class="form-control" placeholder="회사  VAT 번호" name="companyVAT" value="${accountUser.companyVAT}">
								</div>
							</div>
							<br />
